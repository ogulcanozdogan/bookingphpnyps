...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
				...
				<?php
$sorgu = $baglanti->prepare("SELECT id, bookingNumber, createdAt, 'Point A to B Pedicab Ride' AS Type FROM pointatob WHERE status = 'pending' AND driver='$user'
    UNION ALL
    SELECT id, bookingNumber, createdAt, 'Hourly Pedicab Ride' AS Type FROM hourly WHERE status = 'pending' AND driver='$user'
	UNION ALL
	SELECT id, bookingNumber, createdAt, 'Central Park Tour' AS Type FROM centralpark WHERE status = 'pending' AND driver='$user'
