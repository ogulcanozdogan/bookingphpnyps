    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="registerForm" method="post">
                ...
                <div class="form-outline mb-4">
                    <input type="text" name="pdf_id" id="form2Example16" class="form-control" placeholder="Pedicab Registration ID" aria-label="Pedicab Registration ID" required/>
                    <a target='_blank' href="https://newyorkpedicabservices.com/pedicab-driver-registration/">If you don't have, click</a>
                </div>
                <div class="form-outline mb-4">
