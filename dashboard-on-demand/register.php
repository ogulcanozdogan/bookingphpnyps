                    ...
                    <div class="card">
                        <div class="card-body p-5">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                if ($sorgu->rowCount() > 0) {
                                    echo "<font color='red'><strong>Error: This username is already in use!</strong></font><br>";
                                ...
                                if ($sorgu->rowCount() > 0) {
                                    echo "<font color='red'><strong>Error: This email address is already in use!</strong></font><br>";
                                    $is_valid = false; // Hata varsa kayıt durdurulur
                                }
                                ...
                                if ($sorgu->rowCount() > 0) {
                                    echo "<font color='red'><strong>Error: This phone number is already in use!</strong></font><br>";
                                    $is_valid = false; // Hata varsa kayıt durdurulur
                                }
