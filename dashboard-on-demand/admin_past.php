...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
				...
				<?php
$sorgu = $baglanti->prepare("SELECT id, driver, bookingNumber, createdAt, 'Point A to B Pedicab Ride' AS Type FROM pointatob WHERE status = 'past'
    UNION ALL
    SELECT id, driver, bookingNumber, createdAt, 'Hourly Pedicab Ride' AS Type FROM hourly WHERE status = 'past'
    UNION ALL
    SELECT id, driver, bookingNumber, createdAt, 'Central Park Tour' AS Type FROM centralpark WHERE status = 'past'
