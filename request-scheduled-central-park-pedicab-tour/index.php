...
<head>
    ...
    <meta name="description" content="Request Scheduled Central Park Pedicab Tour Form">
    <!-- Preload CSS files -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <div class="text-center mb-4">
                    <b>Scheduled<br>Central Park Pedicab Tour<br>Request Form</b>
                </div>
				            <?php
    ...
    <select title="" class="form-control" id="numPassengers" name="numPassengers" oninvalid="this.setCustomValidity('Please, select the number of passengers.'); this.classList.add('invalid');" 
        ...
        ?>
                ...
                <div class="form-group">
                    ...
                    <input title="" autocomplete="off" type="date" required max="2025-12-31" oninvalid="this.setCustomValidity('Please, select the date of Tour.'); this.classList.add('invalid');"
               ...
               class="form-control" id="pickUpDate" name="pickUpDate">
                ...
                <div class="row">
				 ...
				 <div class="form-group">
                     <label for="serviceDuration">Duration of Tour</label>
                     <select title="" class="form-control" required id="serviceDuration" name="serviceDuration" oninvalid="this.setCustomValidity('Please, select duration of Tour.'); this.classList.add('invalid');" oninput="setCustomValidity(''); this.classList.remove('invalid');">
                        <option value="">Select the duration of Tour</option>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                     <label for="serviceDetails">Tour Details</label>
                     <textarea class="form-control" id="serviceDetails" required placeholder="Please, send us more details about this Tour." oninvalid="this.setCustomValidity('Please, send us more details about this Tour.'); this.classList.add('invalid');" oninput="setCustomValidity(''); this.classList.remove('invalid');" name="serviceDetails" rows="3"></textarea>
                  </div>
				<div class="form-group">
...
function checkZipCodes(pickUpZip, destinationZip) {
 ...
 showError("You are trying to book a ride inside of our main service areas.<br> Please use this app: <a href='https://newyorkpedicabservices.com/book-scheduled-central-pedicab-tour/'>Book Scheduled Central Park Pedicab Tour</a>");
