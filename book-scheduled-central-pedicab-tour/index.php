...
?>>
    ...
    <?php 
    if ($_GET['error'] == 'yes') {
        echo "You are trying to book a tour outside of our main service areas.<br>Please, use the form below instead.<br><a href='https://newyorkpedicabservices.com/request-central-park-pedicab-tour.html'>Request Central Park Pedicab Tour</a>";
    }
    ?>
    </div>
</div>
                     ...
                     <select title="" class="form-control" id="numPassengers" name="numPassengers" required  oninvalid="this.setCustomValidity('Please, select the number of Passengers.'); this.classList.add('invalid');" 
                        ...
                        <?php
                           ...
                           foreach ($passengerCounts as $count) {
                               ...
                               if (isset($_POST['numPassengers']) && $_POST['numPassengers'] == $count) {
                                   echo ' selected';
                               }
                               echo '>' . $count . '</option>';
                           }
               ...
               class="form-control" id="pickUpDate" name="pickUpDate" value="<?php echo isset($pickUpDate) ? htmlspecialchars($pickUpDate) : ''; ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-12">
                           <div class="form-check">
                              <input title="" class="form-check-input" required type="radio" name="tourDuration" id="duration40" value="40" <?php echo (isset($_POST['tourDuration']) && $_POST['tourDuration'] == '40') ? 'checked' : ''; ?>>
                        ...
                        <div class="col-12">
                           <div class="form-check">
                              <input title="" class="form-check-input" required type="radio" name="tourDuration" id="duration60" value="60" <?php echo (isset($_POST['tourDuration']) && $_POST['tourDuration'] == '60') ? 'checked' : ''; ?>>
                        ...
                        <div class="col-12">
                           <div class="form-check">
                              <input title="" class="form-check-input" required type="radio" name="tourDuration" id="duration90" value="90" <?php echo (isset($_POST['tourDuration']) && $_POST['tourDuration'] == '90') ? 'checked' : ''; ?>>
				...
				<!-- <div id="coordinates-display" style="margin-top: 20px;"></div> -->
                  ...
                  <div class="form-group">
                     ...
                     <input title="" type="text" class="form-control" required placeholder="Please, enter start address." oninvalid="this.setCustomValidity('Please, enter pick up address.'); this.classList.add('invalid');" oninput="setCustomValidity(''); this.classList.remove('invalid');" id="pickUpAddress" name="pickUpAddress" value="<?php echo isset($_POST['pickUpAddress']) ? htmlspecialchars($_POST['pickUpAddress']) : ''; ?>">
                  </div>
                  <!-- Destination Address -->
                  <div class="form-group">
                     <label for="destinationAddress">Finish Address</label>
                     <input title="" type="text" class="form-control" required placeholder="Please, enter finish address." oninvalid="this.setCustomValidity('Please, enter destination address.'); this.classList.add('invalid');" oninput="setCustomValidity(''); this.classList.remove('invalid');" id="destinationAddress" name="destinationAddress" value="<?php echo isset($_POST['destinationAddress']) ? htmlspecialchars($_POST['destinationAddress']) : ''; ?>">
                  </div>
                  <!-- Payment Method -->
                  <div class="form-group">
                     <label>Driver Paid Separately</label>
                     <div class="form-check">
                        <input title="" class="form-check-input" type="radio" name="paymentMethod" id="payCash" value="CASH" <?php echo isset($_POST['paymentMethod']) && $_POST['paymentMethod'] == 'CASH' ? 'checked' : ''; ?> required>
                        <label class="form-check-label" for="payCash">
                        I will pay the driver cash
                        </label>
                     </div>
                     <div class="form-check">
                        <input title="" class="form-check-input" type="radio" name="paymentMethod" id="payCard" value="card" <?php echo isset($_POST['paymentMethod']) && $_POST['paymentMethod'] == 'card' ? 'checked' : ''; ?> required>
