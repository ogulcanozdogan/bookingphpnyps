...
<html>
<body>
    <h2>Scheduled Point A to B Pedicab Ride Request</h2>
    ...
    <p><strong>Date of Pick Up = </strong> $pickUpDate ($pickUpDay)</p>
...
try {
    ...
    $sql = "INSERT INTO scheduled_a_to_b_requests (
                requestNumber, first_name, last_name, email, phone_number, 
                num_passengers, pick_up_date, hours, minutes, am_pm, 
                pick_up_address, destination_address, down_payment, payment_method, created_at
            ) VALUES (
                :requestNumber, :first_name, :last_name, :email, :phone_number, 
                :num_passengers, :pick_up_date, :hours, :minutes, :am_pm, 
                :pick_up_address, :destination_address, :down_payment, :payment_method, :ny_datetime
            )";
