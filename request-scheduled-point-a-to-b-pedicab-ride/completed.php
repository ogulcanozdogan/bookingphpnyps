...
$emailAddress = isset($_POST["emailAddress"]) ? htmlspecialchars($_POST["emailAddress"]) : ''; // Değiştirildi
$phoneNumber = isset($_POST["phoneNumber"]) ? htmlspecialchars($_POST["phoneNumber"]) : ''; // Değiştirildi
$numPassengers = isset($_POST["numPassengers"]) ? htmlspecialchars($_POST["numPassengers"]) : '';
$pickUpDate = isset($_POST["pickUpDate"]) ? htmlspecialchars($_POST["pickUpDate"]) : ''; // Değiştirildi
$pickUpDay = isset($_POST["pickUpDay"]) ? htmlspecialchars($_POST["pickUpDay"]) : ''; // Değiştirildi
$timeOfPickUp = isset($_POST["timeOfPickUp"]) ? htmlspecialchars($_POST["timeOfPickUp"]) : ''; // Değiştirildi
...
$paymentDescription = isset($_POST["paymentDescription"]) ? htmlspecialchars($_POST["paymentDescription"]) : ''; // Değiştirildi
