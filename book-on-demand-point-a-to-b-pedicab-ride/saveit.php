...
function saveBooking($data, $pdo) {
    try {
        ...
        $sql = "INSERT INTO temporaryBookings (unique_id, num_passengers, pick_up_address, destination_address, payment_method, first_name, last_name, email, phone_number, booking_fee, driver_fare, total_fare, ride_duration, return_duration, operation_fare, pick_up_duration, hub, hourly_operation_fare, country_code) 
                VALUES (:unique_id, :num_passengers, :pick_up_address, :destination_address, :payment_method, :first_name, :last_name, :email, :phone_number, :booking_fee, :driver_fare, :total_fare, :ride_duration, :return_duration, :operation_fare, :pick_up_duration, :hub, :hourly_operation_fare, :country_code)";
