            ...
            class="form-control" id="pickUpDate" name="pickUpDate" value="<?php echo isset($_GET['pickUpDate']) ? htmlspecialchars($_GET['pickUpDate']) : ''; ?>">                 </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-check">
                        <input title="" class="form-check-input" type="radio" required name="paymentMethod" id="payCash" value="cash" <?php echo isset($_GET['paymentMethod']) && $_GET['paymentMethod'] == 'cash' ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="payCash">
                        I will pay the driver cash
                        </label>
                     </div>
                     <div class="form-check">
                        <input title="" class="form-check-input" type="radio" required name="paymentMethod" id="payCard" value="card" <?php echo isset($_GET['paymentMethod']) && $_GET['paymentMethod'] == 'card' ? 'checked' : ''; ?>>
