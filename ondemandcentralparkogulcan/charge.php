...
<body>
    ...
    // New York zaman dilimi ile şu anki zamanı oluştur
   ...
   // New York saatini almak için timezone ayarlama
...
<p><strong>Date of Tour:</strong> ' . htmlspecialchars($orderMonth) .'/'. htmlspecialchars($orderDay) .'/'. htmlspecialchars($orderYear) . '</p>
<p><strong>Time of Tour:</strong> ' . htmlspecialchars($current_time) . '</p>
...
';
            ...
            $htmlContent1 = <<<EOD
                ...
                <body>
                    ...
                    <p><strong>Route:</strong> <a href='https://newyorkpedicabservices.com/ondemandcentralparkogulcan/route/index.php?bookingNumber=$bookingNumber' target='_blank'> View Route</a></p>    
                    ...
                    <p><strong>Date of Tour:</strong> $orderMonth/$orderDay/$orderYear</p>
                    <p><strong>Time of Tour:</strong> $current_time</p>     
                    ...
                    <h2>Driver Note</h2>
                   <strong>Type:</strong> On Demand Central Park Pedicab Tour<br><strong>First:</strong> $firstName<br><strong>Last:</strong> $lastName<br><strong>Phone:</strong> $phoneNumber<br><strong>Passengers:</strong> $numPassengers<br><strong>Date:</strong> $orderMonth/$orderDay/$orderYear<br><strong>Time:</strong> $current_time<br><strong>Tour Duration:</strong> $tourDuration<br><strong><strong>Ride Duration:</strong> {$rideDuration} minutes</strong><br><strong>Start:</strong> $pickUpAddress<br><strong>Finish:</strong> $destinationAddress<br><strong>Pay:</strong> \${$driverFare} with $paymentMethod by customer $firstName $lastName
                </body>
                </html>
                EOD;
            ...
            $message = "On Demand Central Park Pedicab Tour available!
            {". $bookingNumber ."}";
