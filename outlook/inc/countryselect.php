...
function countrySelector($defaultCountry = "", $id = "", $name = "", $classes = "", $countryName = ""){
    ...
    foreach($countryArray as $code => $country){
        $countryNameFormatted = ucwords(strtolower($country["name"])); // Making it look good
        
        $selected = ''; // Initialize selected variable
        
        // Sadece countryName ile karşılaştır
        $selected = ($countryName == $country["name"]) ? 'selected' : '';
        
        $output .= "<option " . $selected . " value='" . $country["code"] . "' data-country-name='" . $country["name"] . "'>(+" . $country["code"] . ") " . $countryNameFormatted . " </option>";
    }
