...
<html>
<body>
    <h2>Scheduled Hourly Pedicab Service Request</h2>
    ...
    <p><strong>Date of Service = </strong> $pickUpDate ($pickUpDay)</p>
...
$email1->setSubject("Scheduled Hourly Pedicab Service Request - " . $requestNumber);
...
$email2->setSubject("Scheduled Hourly Pedicab Service Request - " . $requestNumber);
...
try {
    ...
    $sql = "INSERT INTO scheduled_hourly_requests (
                requestNumber, first_name, last_name, email, phone_number, 
                num_passengers, pick_up_date, hours, minutes, am_pm, service_duration,
                pick_up_address, destination_address, service_details, payment_method, created_at
            ) VALUES (
                :requestNumber, :first_name, :last_name, :email, :phone_number, 
                :num_passengers, :pick_up_date, :hours, :minutes, :am_pm, :service_duration, 
                :pick_up_address, :destination_address, :service_details, :payment_method, :ny_datetime
            )";
