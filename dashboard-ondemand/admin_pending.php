...
?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
				...
				<?php
$sorgu = $baglanti->prepare("SELECT id, driver, bookingNumber, createdAt, 'Point A to B Pedicab Ride' AS Type FROM pointatob WHERE status = 'pending'
    UNION ALL
    SELECT id, driver, bookingNumber, createdAt, 'Hourly Pedicab Ride' AS Type FROM hourly WHERE status = 'pending'
    UNION ALL
    SELECT id, driver, bookingNumber, createdAt, 'Central Park Tour' AS Type FROM centralpark WHERE status = 'pending'
                                    ...
                                    <div class="vstack gap-2">
                                        <div class="form-check card-radio">
                                            <input id="listGroupRadioGrid1" name="listGroupRadioGrid" type="radio" class="form-check-input">
                                                ...
                                                </div>Driver = <b style='color:red;'><?php 
